        ...
        <div class="relative ml-3 flex">
            @if ( auth()->check() )
                @if ( Auth::user()->status == 1 )
                    <a class="me-4 relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" href="{{ route('admin') }}">Admin</a>   
                @endif
            <div>
            ...
            @else
                <a class="me-4" href="{{ route('login') }}">Login</a>
